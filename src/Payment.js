...
function Payment() {
    ...
    useEffect(() => {
        //runs when the payment component loads as well as when [] changes
        //generete the special stripe sevret which allows us to charge a customer
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="payment__priceContainer">
                                ...
                                <button disabled={processing || disabled || succeeded}>
                                    <span>{processing ? <p>Procressing</p> : "Buy Now"}</span>
                                </button>
                            </div>
